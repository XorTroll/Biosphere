...
BIOSPHERE_LIBNRO_LDFLAGS := -lbio-libNRO $(BIOSPHERE_BASE_LIBS)

BIOSPHERE_NSO_STANDALONE_LDFLAGS := -lbio-NSO $(BIOSPHERE_EXECUTABLE_LDFLAGS)
BIOSPHERE_NSO_EXEFS_LDFLAGS := $(BIOSPHERE_BASE_LIBS) $(BIOSPHERE_ROOT)/libbio/lib/libbio-sdk.nss

ifeq ($(TARGET_MODE),EXEFS)

BIOSPHERE_NSO_FLAGS	:=	BIOSPHERE_NSO_EXEFS_LDFLAGS

else

BIOSPHERE_NSO_FLAGS	:=	BIOSPHERE_NSO_STANDALONE_LDFLAGS
